document.addEventListener('DOMContentLoaded', () => {
    const select1 = new CustomSelect('#select-1', {
        ...
        options: [['none', 'Выберите версию'], ['1.18.2', '1.18.2'], ['1.16.5', '1.16.5'], ['1.15.2', '1.15.2'], ['1.14.4', '1.14.4'], ['1.12.2', '1.12.2'], ['Другая', 'Другая']], // опции
    ...
    const select2 = new CustomSelect('#select-2', {
        ...
        targetValue: 'none', // значение по умолчанию
        options: [['none', 'Выберите тип'], ['Карта', 'Карта'], ['Схематика', 'Схематика'], ['Ресурс-пак', 'Ресурс-пак'], ['Мир', 'Мир'], ['Сборка модов', 'Сборка модов'], ['Сборка плагинов', 'Сборка плагинов'], ['Остальное', 'Остальное']], // опции
        onSelected(select, option) {
            // выбранное значение
            console.log(`Выбранное значение: ${select.value}`);
            // индекс выбранной опции
